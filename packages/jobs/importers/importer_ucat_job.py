# packages/jobs/importers/importer_ucat.job.py
...
def main(gdb_path: Path, distribuidora: str, ano: int, camada: str = "UCAT_tab", modo_debug: bool = False):
    ...
    df_demanda = pd.DataFrame({
        "id": df["COD_ID"], "uc_id": df["COD_ID"],
        "dem_ponta": dem_p, "dem_fora_ponta": dem_f
    })
